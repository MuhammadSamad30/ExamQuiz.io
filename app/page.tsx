  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center items-center p-8 rounded-lg border-2 bg-[#632727c9]">
        ...
        <p className="text-center text-[#75e6ba] mt-4 font-medium max-w-xl animate__animated animate__fadeIn animate__delay-2s">
        ...
        <Link
          href={`/quiz`}
          className="mt-6 px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg shadow-lg transform transition duration-500 hover:scale-105 hover:bg-blue-700 animate__animated animate__fadeIn animate__delay-3s"
        >
          Start Quiz
        </Link>
      </div>
